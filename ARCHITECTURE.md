...
├── cards/
│   ├── cards.json          Generated index of all 683 tools
│   └── <tool-name>.html    683 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 683 cards.** They share one
...
cannot silently drop the 683 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 683 cards):
