...
├── cards/
│   ├── cards.json          Generated index of all 693 tools
│   └── <tool-name>.html    693 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 693 cards.** They share one
...
cannot silently drop the 693 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 693 cards):
