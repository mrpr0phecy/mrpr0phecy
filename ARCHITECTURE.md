...
├── cards/
│   ├── cards.json          Generated index of all 692 tools
│   └── <tool-name>.html    692 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 692 cards.** They share one
...
cannot silently drop the 692 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 692 cards):
