...
├── cards/
│   ├── cards.json          Generated index of all 673 tools
│   └── <tool-name>.html    673 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 673 cards.** They share one
...
cannot silently drop the 673 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 673 cards):
