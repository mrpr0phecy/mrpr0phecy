...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 719 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 719 tools
│   └── <tool-name>.html    719 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 719 cards.** They share one
...
**654** and the sitemap has **719** URLs (updated across README, ARCHITECTURE,
...
At that point, the tool count reached **664** across **27 categories**, and the sitemap had **719**
...
**27 categories**; `sitemap.xml` had **719 URLs**. Counts, the homepage ItemList,
