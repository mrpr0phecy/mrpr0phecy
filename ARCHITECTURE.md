...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1119 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1119 tools
│   └── <tool-name>.html    1119 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1119 cards.** They share one
...
# 4. Bump the count in index.html: "Search 1119+ free tools" -> 501+
...
**ID collisions across cards.** All 1119 share one DOM. See §3.
...
# Music work (skip images and the 1119 cards):
