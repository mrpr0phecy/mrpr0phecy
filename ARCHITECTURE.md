...
├── cards/
│   ├── cards.json          Generated index of all 677 tools
│   └── <tool-name>.html    677 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 677 cards.** They share one
...
cannot silently drop the 677 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 677 cards):
