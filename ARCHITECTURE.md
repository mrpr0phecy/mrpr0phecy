...
├── cards/
│   ├── cards.json          Generated index of all 679 tools
│   └── <tool-name>.html    679 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 679 cards.** They share one
...
cannot silently drop the 679 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 679 cards):
