...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1154 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1154 tools
│   └── <tool-name>.html    1154 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1154 cards.** They share one
...
`sitemap.xml` lists all 1197 indexable pages (including 1154 cards). Build it
...
**ID collisions across cards.** All 1154 share one DOM. See §3.
...
# Music work (skip images and the 1154 cards):
