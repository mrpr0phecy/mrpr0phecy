...
├── cards/
│   ├── cards.json          Generated index of all 687 tools
│   └── <tool-name>.html    687 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 687 cards.** They share one
...
cannot silently drop the 687 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 687 cards):
