...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1126 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1126 tools
│   └── <tool-name>.html    1126 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1126 cards.** They share one
...
# 4. Bump the count in index.html: "Search 1126+ free tools" -> 501+
...
`sitemap.xml` lists all 1197 indexable pages (including 1126 cards). Build it
...
**ID collisions across cards.** All 1126 share one DOM. See §3.
...
# Music work (skip images and the 1126 cards):
