...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 724 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 724 tools
│   └── <tool-name>.html    724 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 724 cards.** They share one
...
**654** and the sitemap has **724** URLs (updated across README, ARCHITECTURE,
...
At that point, the tool count reached **664** across **27 categories**, and the sitemap had **724**
...
**27 categories**; `sitemap.xml` had **724 URLs**. Counts, the homepage ItemList,
