...
├── cards/
│   ├── cards.json          Generated index of all 685 tools
│   └── <tool-name>.html    685 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 685 cards.** They share one
...
cannot silently drop the 685 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 685 cards):
