...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1181 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1181 tools
│   └── <tool-name>.html    1181 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1181 cards.** They share one
...
# 4. Bump the count in index.html: "Search 1181+ free tools" -> 501+
...
tree, so a sparse checkout does not silently drop the 1181 cards:
...
**ID collisions across cards.** All 1181 share one DOM. See §3.
...
# Music work (skip images and the 1181 cards):
