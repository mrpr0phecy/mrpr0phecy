...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1305 self-contained browser tools | `index.html` | People searching for a specific tool |
...
│   ├── cards.json          Generated full index of all 1305 tools (descriptions feed search)
│   └── <tool-name>.html    1305 tool fragments (NOT full documents)
...
- **One place a tool can go wrong.** `tool.html` fails the same way for all
  1,305 tools, and `scripts/check-tool-graph.py` proves every link into it
...
- **`[data-explore="json"]`** — an empty container. Everything below the fold
  (the filterable list of all 1,305 tools) is fetched on scroll and built 60
...
2. **Element IDs must be globally unique across all 1305 cards.** They share one
...
| 171 | Productivity & Lifestyle | | 29 | Museum & Collection |
| 94 | Finance & Money | | 22 | Virtual Worlds & Gaming |
| 77 | SaaS & Business Killers | | 19 | AI & Autonomous Agents |
| 73 | Writing & Language | | 17 | Mind-Blowing Demos |
| 72 | Algorithms & Computer Science | | 13 | Lucid Dreaming & Sleep |
| 64 | Mathematics | | 11 | Survival & Emergency Readiness |
| 56 | Sports | | 10 | Anime & Otaku Culture |
| 53 | Interactive Art & Living Worlds | | 10 | Aquatics & Fishkeeping |
| 48 | Health & Fitness | | 10 | Birdwatching & Ornithology |
| 43 | Home & DIY | | 10 | Dogs & Canine Care |
...
Total: 1305 tools in 29 categories.
---
...
`sitemap.xml` lists all 1197 indexable pages (including 1305 cards). Build it
...
# Music work (skip images and the 1305 cards):
...
1305 tools in `cards/` across 29 categories, one shared DOM, every derived
