...
├── cards/
│   ├── cards.json          Generated index of all 669 tools
│   └── <tool-name>.html    669 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 669 cards.** They share one
...
cannot silently drop the 669 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 669 cards):
