...
├── cards/
│   ├── cards.json          Generated index of all 676 tools
│   └── <tool-name>.html    676 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 676 cards.** They share one
...
cannot silently drop the 676 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 676 cards):
