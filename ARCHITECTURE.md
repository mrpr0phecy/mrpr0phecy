...
├── cards/
│   ├── cards.json          Generated index of all 681 tools
│   └── <tool-name>.html    681 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 681 cards.** They share one
...
cannot silently drop the 681 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 681 cards):
