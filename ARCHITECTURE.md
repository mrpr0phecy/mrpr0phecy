...
|---|---|---|---|---|
| 137 | Science & Engineering | | 11 | SaaS & Business Killers |
...
| 28 | Mathematics | | 15 | Astronomy & Space |
...
- **17 `<label for=...>` associations point at no element** (they label button
  ...
  adding `aria-labelledby`. Since all 664 cards share one DOM, `getElementById` can bind to the
...
- **`sw.js` is still unregistered** — see the open question below. For a site of
  664 offline-first tools it is a large caching win (network-first for HTML,
