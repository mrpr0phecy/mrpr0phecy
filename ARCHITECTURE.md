...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1206 self-contained browser tools | `index.html` | People searching for a specific tool |
...
│   ├── cards.json          Generated full index of all 1206 tools (descriptions feed search)
│   └── <tool-name>.html    1206 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1206 cards.** They share one
...
Total: 1206 tools in 28 categories.
---
...
`sitemap.xml` lists all 1197 indexable pages (including 1206 cards). Build it
...
**ID collisions across cards.** All 1206 share one DOM. See §3. A parked subtree
...
# Music work (skip images and the 1206 cards):
...
1206 tools in `cards/` across 28 categories, one shared DOM, every derived
