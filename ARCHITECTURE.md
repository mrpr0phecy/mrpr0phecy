...
├── cards/
│   ├── cards.json          Generated index of all 675 tools
│   └── <tool-name>.html    675 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 675 cards.** They share one
...
cannot silently drop the 675 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 675 cards):
