...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1211 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1211 tools
│   └── <tool-name>.html    1211 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1211 cards.** They share one
...
# 4. Bump the count in index.html: "Search 1211+ free tools" -> 501+
...
tree, so a sparse checkout does not silently drop the 1211 cards:
...
**ID collisions across cards.** All 1211 share one DOM. See §3.
...
# Music work (skip images and the 1211 cards):
