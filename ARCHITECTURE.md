...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1223 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1223 tools
│   └── <tool-name>.html    1223 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1223 cards.** They share one
...
# 4. Bump the count in index.html: "Search 1223+ free tools" -> 501+
...
tree, so a sparse checkout does not silently drop the 1223 cards:
...
**ID collisions across cards.** All 1223 share one DOM. See §3.
...
# Music work (skip images and the 1223 cards):
