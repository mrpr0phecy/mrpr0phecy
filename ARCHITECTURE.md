...
├── cards/
│   ├── cards.json          Generated index of all 690 tools
│   └── <tool-name>.html    690 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 690 cards.** They share one
...
cannot silently drop the 690 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 690 cards):
