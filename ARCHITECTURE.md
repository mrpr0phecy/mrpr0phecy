...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 704 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 704 tools
│   └── <tool-name>.html    704 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 704 cards.** They share one
...
**654** and the sitemap has **704** URLs (updated across README, ARCHITECTURE,
