...
├── cards/
│   ├── cards.json          Generated index of all 678 tools
│   └── <tool-name>.html    678 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 678 cards.** They share one
...
cannot silently drop the 678 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 678 cards):
