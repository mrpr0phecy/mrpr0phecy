...
├── cards/
│   ├── cards.json          Generated index of all 670 tools
│   └── <tool-name>.html    670 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 670 cards.** They share one
...
cannot silently drop the 670 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 670 cards):
