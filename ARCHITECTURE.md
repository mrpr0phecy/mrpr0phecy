...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1177 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1177 tools
│   └── <tool-name>.html    1177 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1177 cards.** They share one
...
Total: 1177 tools in 27 categories.
---
...
`sitemap.xml` lists all 1197 indexable pages (including 1177 cards). Build it
...
**ID collisions across cards.** All 1177 share one DOM. See §3.
...
# Music work (skip images and the 1177 cards):
