...
├── cards/
│   ├── cards.json          Generated index of all 671 tools
│   └── <tool-name>.html    671 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 671 cards.** They share one
...
cannot silently drop the 671 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 671 cards):
