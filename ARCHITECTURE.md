...
├── cards/
│   ├── cards.json          Generated index of all 672 tools
│   └── <tool-name>.html    672 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 672 cards.** They share one
...
cannot silently drop the 672 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 672 cards):
