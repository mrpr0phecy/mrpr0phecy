...
├── cards/
│   ├── cards.json          Generated index of all 691 tools
│   └── <tool-name>.html    691 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 691 cards.** They share one
...
cannot silently drop the 691 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 691 cards):
