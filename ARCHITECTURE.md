...
├── cards/
│   ├── cards.json          Generated index of all 668 tools
│   └── <tool-name>.html    668 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 668 cards.** They share one
...
cannot silently drop the 668 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 668 cards):
