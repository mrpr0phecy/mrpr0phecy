...
├── cards/
│   ├── cards.json          Generated index of all 682 tools
│   └── <tool-name>.html    682 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 682 cards.** They share one
...
cannot silently drop the 682 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 682 cards):
