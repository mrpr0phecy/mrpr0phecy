...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 1131 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 1131 tools
│   └── <tool-name>.html    1131 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 1131 cards.** They share one
...
Total: 1131 tools in 27 categories.
---
...
`sitemap.xml` lists all 1197 indexable pages (including 1131 cards). Build it
...
**ID collisions across cards.** All 1131 share one DOM. See §3.
...
# Music work (skip images and the 1131 cards):
