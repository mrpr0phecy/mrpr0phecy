...
|---|---|---|---|
| **A** | **The Most Useful Site In The World** — 650 self-contained browser tools | `index.html` | People searching for a specific tool |
...
├── cards/
│   ├── cards.json          Generated index of all 650 tools
│   └── <tool-name>.html    650 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 650 cards.** They share one
...
# 4. Sync every published count + regenerate the sitemap (D-001):
...
### Categories (650 tools)

| Count | Category | | Count | Category |
|---|---|---|---|---|
| 122 | Science & Engineering | | 11 | SaaS & Business Killers |
| 113 | Productivity & Lifestyle | | 10 | AI & Autonomous Agents |
| 53 | Sports | | 10 | Algorithms & Computer Science |
| 49 | Writing & Language | | 10 | Anime & Otaku Culture |
| 35 | Finance & Money | | 10 | Aquatics & Fishkeeping |
| 29 | Mathematics | | 10 | Astronomy & Space |
| 27 | Home & DIY | | 10 | Birdwatching & Ornithology |
| 23 | Music & Audio | | 10 | Dogs & Canine Care |
| 22 | Health & Fitness | | 10 | Mind-Blowing Demos |
| 15 | Culinary & Food Science | | 10 | MrProphecy Arcade |
| 12 | Museum & Collection | | 10 | Natural Remedies & Herbs |
| 11 | Interactive Art & Living Worlds | | 10 | Wellbeing & Community |
| 11 | Lucid Dreaming & Sleep | | 7 | Virtual Worlds & Gaming |
...
`sitemap.xml` lists all 690 pages. Build it from git rather than the working
tree, so a sparse checkout does not silently drop the 650 cards:
...
**ID collisions across cards.** All 650 share one DOM. See §3.
...
# Music work (skip images and the 650 cards):
...
- **17 `<label for=...>` associations point at no element** (they label button
  ...
  adding `aria-labelledby`. Since all 650 cards share one DOM, `getElementById` can bind to the
...
- **`sw.js` is still unregistered** — see the open question below. For a site of
  650 offline-first tools it is a large caching win (network-first for HTML,
