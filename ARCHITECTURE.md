...
├── cards/
│   ├── cards.json          Generated index of all 686 tools
│   └── <tool-name>.html    686 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 686 cards.** They share one
...
cannot silently drop the 686 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 686 cards):
