...
├── cards/
│   ├── cards.json          Generated index of all 680 tools
│   └── <tool-name>.html    680 tool fragments (NOT full documents)
...
2. **Element IDs must be globally unique across all 680 cards.** They share one
...
cannot silently drop the 680 cards. It escapes spaces in filenames (several
...
# Music work (skip images and the 680 cards):
