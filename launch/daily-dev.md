...
**Title:** `I built 1,295 free browser-side tools in 2 years. Vanilla JS, no build, no npm.`
...
> I\'m a developer in Luton, UK. For the last 2 years I\'ve been building a site with 1,295 free browser-side tools — mortgage calculator, BMI, compound interest, password generator, BPM tapper, JSON formatter, eyepiece calculator, sleep cycle planner, colour contrast checker, invoice generator, and 1,200+ more.
>
...
> - `cards/<tool-name>.html` — one file per tool, 1,295 card files
> - `cards/cards.json` — a single JSON file describing all 1,295 cards (id, name, title, description, category, file)
