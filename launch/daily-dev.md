...
**Title:** `I built 1,260 free browser-side tools in 2 years. Vanilla JS, no build, no npm.`
...
> - `cards/cards.json` — a single JSON file describing all 1,260 cards (id, name, title, description, category, file)
