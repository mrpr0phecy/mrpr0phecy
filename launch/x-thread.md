...
> **1/8**
>
> I spent 2 years building a site with 1,291 free browser-side tools.
>
...
>
> • 1,291 separate card files, one per tool
> • 1 JSON file with an entry for each of the 1,291 cards
> • 1 home page that reads the JSON
> • 1 build script that regenerates the sitemap, RSS, and embed page from the JSON
>
> No npm. No framework. No build step. Total repo: about 91 MB.
...
> The numbers.
>
> 1,291 tools. A repo of about 91 MB. £8/month hosting. £34.50 in donations over 9 months. 12 long-form guides. 3 blog posts. 1 person, evenings and weekends, in Luton, UK.
>
