...
> One person in Luton built 1,260 free browser tools. No display ads, no accounts.

(That is a tested subject line. The 4 specifics — *one person*, *Luton*, *1,260 tools*, *no ads* — are all the things journalists look for. The local town is the hook. The specific number is the hook. The "no X" framing is the news angle.)
...
> - 1,260 free browser-side tools, all in vanilla JavaScript
...
**For local UK press (Luton News, Bedfordshire Live, BBC Three Counties):** the *local* angle. "Luton developer builds 1,260 free tools in his evenings." Local press runs that kind of story regularly.
