...
# Music work (omit the 656 cards too):
...
1. Write `cards/<tool-name>.html` — an **HTML fragment** (no `<!doctype>`,
   ...
   prefix (`xyz-…`) because all 656 cards share one DOM. Wrap all JS in an
...
- Cards: **656**, all indexed (no orphans), all with title+description
