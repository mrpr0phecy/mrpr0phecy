...
# Music work (omit the 1181 cards too):
...
|---|---|---|
| **A — The Most Useful Site In The World** | `index.html` | **1181** self-contained offline browser tools, indexed by `cards/cards.json` |
...
1. Write `cards/<tool-name>.html` — an **HTML fragment** (no `<!doctype>`,
   ...
   prefix (`xyz-…`) because all 1181 cards share one DOM. Wrap all JS in an
