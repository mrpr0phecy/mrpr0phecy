...
# Music work (omit the 649 cards too):
...
1. Write `cards/<tool-name>.html` — an **HTML fragment** (no `<!doctype>`,
   ...
   prefix (`xyz-…`) because all 649 cards share one DOM. Wrap all JS in an
...
- Cards: **649**, all indexed (no orphans), all with title+description
