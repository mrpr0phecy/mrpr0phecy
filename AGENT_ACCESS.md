...
# Music work (omit the 645 cards too):
...
1. Write `cards/<tool-name>.html` — an **HTML fragment** (no `<!doctype>`,
   ...
   prefix (`xyz-…`) because all 645 cards share one DOM. Wrap all JS in an
...
- Cards: **645**, all indexed (no orphans), all with title+description
