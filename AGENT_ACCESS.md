...
# Music work (omit the 674 cards too):
...
1. Write `cards/<tool-name>.html` — an **HTML fragment** (no `<!doctype>`,
   ...
   prefix (`xyz-…`) because all 674 cards share one DOM. Wrap all JS in an
...
- Cards: **674**, all indexed (no orphans), all with title+description
