...
# Music work (omit the 643 cards too):
...
1. Write `cards/<tool-name>.html` — an **HTML fragment** (no `<!doctype>`,
   ...
   prefix (`xyz-…`) because all 643 cards share one DOM. Wrap all JS in an
...
- Cards: **643**, all indexed (no orphans), all with title+description
